    ...
    <body>
        ...
        <div class="menu">
            <div data-role="main" class="ui-content">
                <h2><a data-toggle="modal" data-target="#myModal">Add</a>
                    ...
                    <a href="ViewMainController">View All</a>
                </h2>
            </div>
                ...
                <div id="myModal2" class="modal fade" role="dialog">
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form  method="post" action="MCSearchController" >
            ...
            <table>
                ...
                <tbody>
                    <c:forEach items ="${mainListAttribute}" var = "mainClass">
                        <tr>
                            <td>${mainClass.getMainClassificationId()}</td>
                            <td>${mainClass.getMainClassificationName()}</td>              
                            <td>
                                <a href="EditMainController?mainClassificationId=${mainClass.getMainClassificationId()}" id="editBtn${mainClass.getMainClassificationId()}" class="edit" value="${mainClass.getMainClassificationId()}" title="Edit"><i class="material-icons">&#xE254;</i></a>
                            </td>
                            <td>
                                  <a onclick="return confirm('Do you want to delte this record');" href="MCDeleteController?mcid=${mainClass.getMainClassificationId()}" class="delete" title="Delete" data-toggle="tooltip" value="${mainClass.getMainClassificationId()}"><i class="material-icons">&#xE872;</i></a>
        ...
        <script>
            ...
            function deleteFun() {
                ...
                if (r == true) {
                    $.get('MCDeleteController?key=${mainClass.getMainClassificationId()}');
                }
            }
