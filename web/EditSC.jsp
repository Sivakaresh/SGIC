...
//                });
    ...
    <body>
        ...
        <div class="modal-body">
            <form role="form" method="get" action="UpdateSubController" >
                <c:forEach items="${subListAttribute}" var="subList">
                    <div class="form-group">
                        <label for="name"> Sub Classification ID</label>
                        <input type="text" readonly class="form-control" value="${subList.getSubClassificationId()}" id="subid" name="scid" required maxlength="50">


                        <script>
                                        $(document).ready(function () {
                                            $("#mainClassificationList").val("${subList.getMainClassificationId()}");});
                        </script>

                        <label for="name"> Main Classification Name</label>
                        <select class="form-control" name="mainclassification" id="mainClassificationList">
                        ...
                        <input type="text" class="form-control" value="${subList.getSubClassificationName()}" id="subname" name="scname" required maxlength="50">
