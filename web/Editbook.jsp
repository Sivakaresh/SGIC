            ...
            <form action="UpdateBookController" method="get" >
                <c:forEach items="${bookListAttribute}" var="bookList">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" readonly class="form-control" value="${bookList.getBookId()}" id="bookid" name="bookId" required maxlength="50">
                        ...
                        <script>
                            $(document).ready(function () {
                                $("#mainClassificationList").val("${bookList.getMainId()}");
                                $("#subClassificationList").val("${bookList.getSubId()}");
                        ...
                        <select name="subclassification" id="subClassificationList" class="form-control">
                            <c:forEach items="${subListAttribute}" var="subList">
                                <option value="${subList.getSubClassificationId()}">${subList.getSubClassificationName()}</option>
                            </c:forEach>
                        </select>
