 ...
 * @author Sivakaresh
 */
@WebServlet(name = "SCSearchController", urlPatterns = {"/SCSearchController"})
public class SCSearchController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<SC> subList = scDao.searchSub(searchKey);
            
            request.setAttribute("subListAtt", subList);
